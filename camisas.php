...
<html lang="pt-br">
  ...
  <body style="background-color: Honeydew;">
    ...
    <div class="container row mx-xl-auto mx-lg-auto mx-md-auto border mx-sm-auto mx-auto col-md-10 p-3 mt-4 bg-white">
      ...
      <nav aria-label="Navegação de página exemplo" class="mx-xl-auto mx-lg-auto mx-md-auto mx-sm-auto mx-auto mt-4 col-md-7 col-12 p-0">
        <ul class="pagination justify-content-center">
          <li class="page-item disabled">
            <a class="page-link" href="#">Anterior</a>
          </li>
          <li class="page-item"><a class="page-link bg-primary text-white" href="camisas.php">1</a></li>
          ...
          <li class="page-item">
            <a class="page-link" href="camisas2.php">Próximo</a>
          </li>
        </ul>
      </nav>
    </div>
