  ...
  <body style="background-color: Honeydew;">
    ...
    <div class="container row mx-xl-auto mx-lg-auto mx-md-auto border mx-sm-auto mx-auto col-md-10 p-3 mt-4 bg-white">
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2" src="imagens/camisa_dbs.jpg" alt="Livro Battle Royale">
        <div class="card-body">
          <h5 class="card-title">Camisa Dragon Ball Super</h5>
      ...
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2 " src="imagens/camisa_death.jpg" alt="Camisa DBS">
        <div class="card-body">
          <h5 class="card-title">Camisa Death Note</h5>
          <p class="card-text">Camisa estampa full</p>
          <h4 class=""><b>R$ 66,99</b></h4>
          <small class="text-muted">De: <s>R$ 80,00</s></small>
          <hr class="col-xl-11 col-md-11 col-sm-11 col-11">
      ...
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2" src="imagens/camisa_one.jpg" alt="Camisa Fullmetal">
        <div class="card-body">
          <h5 class="card-title">Camisa One Piece</h5>
          <p class="card-text">Camisa estampa full</p>
      ...
      <nav aria-label="Navegação de página exemplo" class="mx-xl-auto mx-lg-auto mx-md-auto mx-sm-auto mx-auto mt-4 col-md-7">
        <ul class="pagination justify-content-center">
          <li class="page-item">
            <a class="page-link" href="camisas.php">Anterior</a>
          </li>
          <li class="page-item"><a class="page-link" href="camisas.php">1</a></li>
          <li class="page-item"><a class="page-link bg-primary text-white" href="camisas2.php">2</a></li>
          ...
          <li class="page-item">
            <a class="page-link" href="camisas3.php">Próximo</a>
          </li>
        </ul>
      </nav>
    </div>
