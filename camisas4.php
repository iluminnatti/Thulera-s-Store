  ...
  <body style="background-color: Honeydew;">
    ...
    <div class="container row mx-xl-auto mx-lg-auto mx-md-auto border mx-sm-auto mx-auto col-md-10 p-3 mt-4 bg-white">
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2" src="imagens/camisa_eva.jpg" alt="Livro Battle Royale">
        <div class="card-body">
          <h5 class="card-title">Camisa Neon Genesis Evagelion</h5>
          <p class="card-text">Camisa estampa full</p>
          <h4 class=""><b>R$ 61,99</b></h4>
      ...
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2 " src="imagens/camisa_yuyu.jpg" alt="Camisa DBS">
        <div class="card-body">
          <h5 class="card-title">Camisa Hiei - Yu Yu Hakusho</h5>
          <p class="card-text">Camisa estampa full</p>
          <h4 class=""><b>R$ 70,99</b></h4>
      ...
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2" src="imagens/camisa_bleach.jpg" alt="Camisa Fullmetal">
        <div class="card-body">
          <h5 class="card-title">Camisa Bleach</h5>
          <p class="card-text">Camisa estampa full</p>
          <h4 class=""><b>R$ 58,55</b></h4>
          <small class="text-muted">De: <s>R$ 62,00</s></small>
          <hr class="col-xl-11 col-md-11 col-sm-11 col-11">
          <button type="button" class="btn btn-danger">Comprar</button>
          <a href="#" class="btn btn-light border w-25 " id="favorito"><img src="imagens/hearticon.png" width="60%"></a>
        </div>
      ...
      <nav aria-label="Navegação de página exemplo" class="mx-xl-auto mx-lg-auto mx-md-auto mx-sm-auto mx-auto mt-4 col-md-7">
        <ul class="pagination justify-content-center">
          <li class="page-item">
            <a class="page-link" href="camisas3.php">Anterior</a>
          </li>
          ...
          <li class="page-item"><a class="page-link" href="camisas3.php">3</a></li>
          <li class="page-item"><a class="page-link bg-primary text-white" href="camisas4.php">4</a></li>
