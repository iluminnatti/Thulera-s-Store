  ...
  <body style="background-color: Honeydew;">
    ...
    <div class="container row mx-xl-auto mx-lg-auto mx-md-auto border mx-sm-auto mx-auto col-md-10 p-3 mt-4 bg-white">
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2" src="imagens/caneca_mirai.jpg" alt="Caneca Mirai Nikki">
        <div class="card-body">
          <h5 class="card-title">Caneca Mirai Nikki</h5>
      ...
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2 " src="imagens/caneca_natsu.jpg" alt="Caneca Fairy Tail">
        <div class="card-body">
          <h5 class="card-title">Caneca Natsu - Fairy Tail</h5>
          <p class="card-text">Caneca de porcelana</p>
          <h4 class=""><b>R$ 29,99</b></h4>
      ...
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2" src="imagens/caneca_saitama.png" alt="Caneca One Punch Man">
        <div class="card-body">
      ...
      <nav aria-label="Navegação de página exemplo" class="mx-xl-auto mx-lg-auto mx-md-auto mx-sm-auto mx-auto mt-4 col-md-7">
        <ul class="pagination justify-content-center">
          <li class="page-item">
            <a class="page-link" href="canecas.php">Anterior</a>
          </li>
          <li class="page-item"><a class="page-link" href="canecas.php">1</a></li>
          <li class="page-item"><a class="page-link bg-primary text-white" href="canecas2.php">2</a></li>
          ...
          <li class="page-item">
            <a class="page-link" href="canecas3.php">Próximo</a>
          </li>
        </ul>
      </nav>
    </div>
