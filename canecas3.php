  ...
  <body style="background-color: Honeydew;">
    ...
    <div class="container row mx-xl-auto mx-lg-auto mx-md-auto border mx-sm-auto mx-auto col-md-10 p-3 mt-4 bg-white">
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2" src="imagens/caneca_remedio.png" alt="Caneca Remédio Café">
        <div class="card-body">
          <h5 class="card-title">Caneca Remédio - Café</h5>
      ...
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2 " src="imagens/caneca_overwatch.jpg" alt="Caneca Overwatch">
        <div class="card-body">
          <h5 class="card-title">Caneca Insígnia - Overwatch</h5>
          <p class="card-text">Caneca de porcelana</p>
          <h4 class=""><b>R$ 29,99</b></h4>
      ...
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2" src="imagens/caneca_link.png" alt="Caneca Link - Zelda">
        <div class="card-body">
          <h5 class="card-title">Camisa Link - The Legend of Zelda</h5>
          <p class="card-text">Caneca de porcelana</p>
          <h4 class=""><b>R$ 29,99</b></h4>
          <small class="text-muted">De: <s>R$ 39,99</s></small>
          <hr class="col-xl-11 col-md-11 col-sm-11 col-11">
      ...
      <nav aria-label="Navegação de página exemplo" class="mx-xl-auto mx-lg-auto mx-md-auto mx-sm-auto mx-auto mt-4 col-md-7">
        <ul class="pagination justify-content-center">
          <li class="page-item">
            <a class="page-link" href="canecas2.php">Anterior</a>
          </li>
          <li class="page-item"><a class="page-link" href="canecas.php">1</a></li>
          <li class="page-item"><a class="page-link" href="canecas2.php">2</a></li>
          <li class="page-item"><a class="page-link bg-primary text-white" href="canecas3.php">3</a></li>
          <li class="page-item"><a class="page-link" href="canecas4.php">4</a></li>
          <li class="page-item">
            <a class="page-link" href="canecas4.php">Próximo</a>
          </li>
        </ul>
      </nav>
    </div>
