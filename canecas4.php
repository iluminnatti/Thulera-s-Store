  ...
  <body style="background-color: Honeydew;">
    ...
    <div class="container row mx-xl-auto mx-lg-auto mx-md-auto border mx-sm-auto mx-auto col-md-10 p-3 mt-4 bg-white">
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2" src="imagens/caneca_gokugod.png" alt="Caneca Goku SSG">
        <div class="card-body">
          <h5 class="card-title">Caneca Goku SSG - Dragon Ball Super</h5>
      ...
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2 " src="imagens/caneca_nanatsu.png" alt="Caneca Natasu no Taizai">
        <div class="card-body">
          <h5 class="card-title">Caneca 7 pecados - Nanatsu no Taizai</h5>
          <p class="card-text">Caneca de porcelana</p>
          <h4 class=""><b>R$ 29,99</b></h4>
      ...
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2" src="imagens/caneca_madara.png" alt="Caneca Madara">
        <div class="card-body">
          <h5 class="card-title">Camisa Madara - Naruto Shippuden</h5>
          <p class="card-text">Caneca de porcelana</p>
          <h4 class=""><b>R$ 29,99</b></h4>
          <small class="text-muted">De: <s>R$ 39,99</s></small>
          <hr class="col-xl-11 col-md-11 col-sm-11 col-11">
      ...
      <nav aria-label="Navegação de página exemplo" class="mx-xl-auto mx-lg-auto mx-md-auto mx-sm-auto mx-auto mt-4 col-md-7">
        <ul class="pagination justify-content-center">
          <li class="page-item">
            <a class="page-link" href="canecas3.php">Anterior</a>
          </li>
          ...
          <li class="page-item"><a class="page-link bg-primary text-white" href="canecas4.php">4</a></li>
