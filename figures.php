  ...
  <body style="background-color: Honeydew;">
    ...
    <div class="container row mx-xl-auto mx-lg-auto mx-md-auto border mx-sm-auto mx-auto col-md-10 p-3 mt-4 bg-white">
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2" src="imagens/allmight.jpg" alt="Action Figure All Might">
        <div class="card-body">
      ...
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2 " src="imagens/trunks.jpg" alt="Action Figure Trunks">
        <div class="card-body">
      ...
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2" src="imagens/hashirama.jpg" alt="Action Figure Hashirama">
        <div class="card-body">
      ...
      <nav aria-label="Navegação de página exemplo" class="mx-xl-auto mx-lg-auto mx-md-auto mx-sm-auto mx-auto mt-4 col-md-7">
        <ul class="pagination justify-content-center">
          ...
          <li class="page-item"><a class="page-link bg-primary text-white" href="figures.php">1</a></li>
          ...
          <li class="page-item">
            <a class="page-link" href="figures2.php">Próximo</a>
          </li>
        </ul>
      </nav>
    </div>
