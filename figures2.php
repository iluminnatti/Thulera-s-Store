  ...
  <body style="background-color: Honeydew;">
    ...
    <div class="container row mx-xl-auto mx-lg-auto mx-md-auto border mx-sm-auto mx-auto col-md-10 p-3 mt-4 bg-white">
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2" src="imagens/figure_freeza.jpg" alt="Action Figure All Might">
        <div class="card-body">
          <h5 class="card-title">Action Figure - Freeza - Dragon Ball Z</h5>
          <p class="card-text">Material: PVC<br>Origem: China<br>Altura: 14 cm<br>Foto: Original do Produto<br>Caixa: Não</p>
      ...
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2 " src="imagens/figure_one.jpg" alt="Action Figure Trunks">
        <div class="card-body">
          <h5 class="card-title">Action Figure - Franky (Filme Z) - One Piece</h5>
          ...
          <small class="text-muted">De: <s>R$ 239,99</s></small>
          <hr class="col-xl-11 col-md-11 col-sm-11 col-11">
          <button type="button" class="btn btn-danger">Comprar</button>
          <a href="#" class="btn btn-light border w-25 " id="favorito"><img src="imagens/hearticon.png" width="60%"></a>
        </div>
      ...
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2" src="imagens/figure_snk.jpg" alt="Action Figure Hashirama">
        <div class="card-body">
          <h5 class="card-title">Action Figure - Nendroid  Eren - Shingeki no Kyojin</h5>
          <p class="card-text">Material: PVC<br>Origem: China<br>Altura: 10 cm<br>Foto: Original do Produto<br>Caixa: Sim</p>
      ...
      <nav aria-label="Navegação de página exemplo" class="mx-xl-auto mx-lg-auto mx-md-auto mx-sm-auto mx-auto mt-4 col-md-7">
        <ul class="pagination justify-content-center">
          <li class="page-item">
            <a class="page-link" href="figures.php">Anterior</a>
          </li>
          <li class="page-item"><a class="page-link" href="figures.php">1</a></li>
          <li class="page-item"><a class="page-link bg-primary text-white" href="figures2.php">2</a></li>
          <li class="page-item"><a class="page-link" href="figures3.php">3</a></li>
          <li class="page-item"><a class="page-link" href="figures4.php">4</a></li>
          <li class="page-item">
            <a class="page-link" href="figures3.php">Próximo</a>
          </li>
        </ul>
      </nav>
    </div>
