  ...
  <body style="background-color: Honeydew;">
    ...
    <div class="container row mx-xl-auto mx-lg-auto mx-md-auto border mx-sm-auto mx-auto col-md-10 p-3 mt-4 bg-white">
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2" src="imagens/figure_tsunade.jpg" alt="Action Figure All Might">
        <div class="card-body">
          <h5 class="card-title">Action Figure - Tsunade - Naruto Shippuden</h5>
          ...
          <small class="text-muted">De: <s>R$ 169,99</s></small>
      ...
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2 " src="imagens/figure_overlord.jpg" alt="Action Figure Trunks">
        <div class="card-body">
          <h5 class="card-title">Action Figure - Nendoroid Albedo- Overlord</h5>
          <p class="card-text">Material: PVC <br>Origem: China <br>Altura: 10cm <br>Foto: Original do Produto <br>Caixa: Sim</p>
      ...
      <div class="card col-md-4 float-md-left mx-sm-auto mx-auto" style="width: 18rem;">
        <img class="card-img-top mt-2" src="imagens/figure_miku.jpg" alt="Action Figure Hashirama">
        <div class="card-body">
          <h5 class="card-title">Action Figure - Hatsune Miku - Idol Pop</h5>
          <p class="card-text">Material: PVC<br>Origem: China<br>Altura: 10cm<br>Foto: Original do Produto<br>Caixa: Sim</p>
          <h4 class=""><b>R$ 149,99</b></h4>
          <small class="text-muted">De: <s>R$ 199,99</s></small>
          <hr class="col-xl-11 col-md-11 col-sm-11 col-11">
      ...
      <nav aria-label="Navegação de página exemplo" class="mx-xl-auto mx-lg-auto mx-md-auto mx-sm-auto mx-auto mt-4 col-md-7">
        <ul class="pagination justify-content-center">
          <li class="page-item">
            <a class="page-link" href="figures3.php">Anterior</a>
          </li>
          ...
          <li class="page-item"><a class="page-link bg-primary text-white" href="figures4.php">4</a></li>
